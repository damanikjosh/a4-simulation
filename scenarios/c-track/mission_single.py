...
async def run():
    ...
    for lon, lat in lon_lat_interp:
        mission_items.append(MissionItem(
            ...
            relative_altitude_m=10,                         # Altitude relative to takeoff altitude in metres
            ...
            acceptance_radius_m=1,                          # Radius for completing a mission item (in metres)
